...
@section('title','LRI | Ajouter une évènement')
...
@section('header_page')
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('evenements')}}">Evénèment</a></li>
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" method="POST" action="{{url('evenements')}}" id="contact_form" enctype="multipart/form-data">
              {{ csrf_field() }}
              <fieldset>

                <!-- Form Name -->
                <legend><center><h2><b>Nouveau évènement</b></h2></center></legend><br>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-md-9 inputGroupContainer @if($errors->get('titre')) has-error @endif">
                          <div class="input-group">
                            ...
                            <input  name="titre" placeholder="Titre" class="form-control"  type="text" value="{{old('titre')}}">
                           </div>
                          ...
                          <label class="col-md-3 control-label">Contenu*</label>
                                <div class="col-md-9 inputGroupContainer @if($errors->get('contenu')) has-error @endif">
                                    <div class="input-group">
                                        ...
                                        <textarea name="contenu" rows="5" style="width:100%" id="txt"></textarea>
                                      </div>
                                      <span class="help-block">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-md-9 inputGroupContainer @if($errors->get('from')) has-error @endif">
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lg fa-calendar"></i></span>
                            <input type="text" class="form-control" name="from" id="event-date" />
                           </div>
                            <span class="help-block">
                                @if($errors->get('from'))
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-md-9 inputGroupContainer @if($errors->get('status')) has-error @endif">
                      <div class="input-group">
                        ...
                        <input id="switch" name="status" type="checkbox" value="1">
