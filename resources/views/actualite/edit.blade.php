      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" method="POST" action="{{url('actualites/'. $actualite->id) }}" id="contact_form" enctype="multipart/form-data">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-md-9 inputGroupContainer @if($errors->get('titre')) has-error @endif">
                          <div class="input-group">
                            ...
                            <input  name="titre" placeholder="Titre" class="form-control"  type="text" value="{{$actualite->titre}}">
                           </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-md-9 inputGroupContainer @if($errors->get('status')) has-error @endif">
                      <div class="input-group">
                        ...
                        <input id="switch" name="status" type="checkbox" value="1" @if($actualite->status===1) checked @endif>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Photo*</label>
                            ...
                            <div class="col-md-9 inputGroupContainer">
                              <div id='actualite-upload' style="background-image:url('{{asset($actualite->photo)}}')">
