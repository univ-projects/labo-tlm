      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" method="POST" action="{{url('stages')}}" id="contact_form" enctype="multipart/form-data">
              {{ csrf_field() }}
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-md-9 inputGroupContainer @if($errors->get('from')) has-error @endif">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="from" id="event-date2" />
                           </div>
